...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[1] = LAYOUT_65_ansi_blocker(KC_GRV, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, KC_MNXT, KC_MUTE, BL_BRTG, BL_INC, RGB_VAI, RGB_MOD, RGB_SPI, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_PSCR, KC_SLCK, KC_PAUS, KC_MPRV, KC_MSTP, BL_TOGG, BL_DEC, RGB_VAD, RGB_RMOD, RGB_SPD, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, DF(0), KC_TRNS, KC_VOLU, KC_TRNS, RGB_M_K, RGB_TOG, RGB_M_SW, KC_NO, RESET, MAGIC_TOGGLE_NKRO, MAGIC_HOST_NKRO, MAGIC_UNHOST_NKRO, DF(2), DF(1), KC_TRNS, KC_PGUP, KC_VOLD, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_INS, KC_PGDN, KC_END),
	[2] = LAYOUT_65_ansi_blocker(L_BRI, L_BRD, L_PTN, L_PTP, L_PSI, L_PSD, L_T_MD, L_T_ONF, L_ON, L_OFF, L_T_BR, L_T_PTD, KC_M, L_MIKE, DF(0), KC_TAB, KC_QUOT, KC_COMM, KC_DOT, KC_P, KC_Y, KC_F, KC_G, KC_C, KC_R, KC_L, KC_SLSH, KC_EQL, KC_BSLS, DF(1), KC_CAPS, KC_A, KC_O, KC_E, KC_U, KC_I, KC_D, KC_H, KC_T, KC_N, KC_S, KC_MINS, KC_ENT, KC_NO, KC_LSFT, KC_SCLN, KC_Q, KC_J, KC_K, KC_X, KC_B, KC_M, KC_W, KC_V, KC_Z, KC_RSFT, KC_UP, KC_NO, KC_LCTL, KC_LGUI, KC_LALT, KC_SPC, KC_RALT, MO(1), KC_LEFT, KC_DOWN, KC_RGHT)
};
